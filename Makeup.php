...
<html lang="en">
      ...
      <nav class="navbar navbar-expand-sm navbar-dark fixed-top pl-5 pt-4 pb-4">
         ...
         <div class="collapse navbar-collapse" id="myMenu">
            <ul class="navbar-nav pl-5 custom-nav custom-carets">
               <li class="nav-item pr-3"><a href="UniProject.php" class="nav-link">Home</a></li>
    ...
    <header class="jumbotron back-image" style="background-image: url(Images/UniImages/c2.jpg);">
    ...
    <h2 class="text-center mt-3">MAKEUP PRODUCTS</h2>
    </div>
    ...
    $db=new dbconn();
    $save_res=$db->loaddata1();
    foreach($save_res as $row){
      //print_r($save_res);
      ?>
         <!-- Start 1st Card -->
         <div class="col-lg-3 col-sm-6">
            <form action="MakeupAddToCart.php" method="post">
             <div class="card mb-3">
               <div class="card-body text-center pt-0 pl-0 pr-0 pb-0">
                  <img class="card-img-top square" style="width: 250px; height: 250px;" src="<?php echo $row['Makeup_image']  ?>" alt="Card image cap">
                  <p class="blockquote-footer mt-3"><?php echo $row['Makeup_name'] ?></p>
                  <p class="m">Rs.<?php echo $row['Makeup_price'] ?></p>
                  <input type="hidden" name="makeup_id" value="<?php echo $row['Makeup_ID']  ?>" >             
                  <input type="hidden" name="makeup_name" value="<?php echo $row['Makeup_name']  ?>" >             
                  <input type="hidden" name="makeup_price" value=" <?php echo $row['Makeup_price']  ?>" >             
                 
                  <input class="text-center form-control" type="number" name="makequantity" min="1" max="5" placeholder="Quantity: " >
               </div>
